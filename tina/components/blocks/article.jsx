...
export default function Article({ data }) {
    return (
        <div id={data.id} className='container py-28'>
            <article
                className='prose lg:prose-xl prose-neutral max-w-full prose-a:text-[#933745] prose-img:rounded-2xl prose-pre:bg-[#f6f8fa] prose-pre:text-[#393a34] prose-headings:font-playfair-display prose-headings:font-normal prose-h1:text-6xl prose-h1:lg:text-8xl prose-h2:text-5xl prose-h2:lg:text-6xl prose-h3:text-3xl prose-h3:lg:text-4xl prose-h4:text-2xl prose-h4:lg:text-3xl prose-h5:text-xl prose-h5:lg:text-2xl prose-h6:text-lg prose-h6:lg:text-xl'
                ...
                <TinaMarkdown
                    ...
                    components={{
                        ...
                        code_block: ({ value, lang, ...props }) => (
                            <CodeBlock value={value} lang={lang} {...props} />
                        ),
                    }}
                />
            </article>
